...
🔐 **Security Enthusiast | MCA Cybersecurity | SOC Analyst in Making**  

I am passionate about **Cybersecurity, Web Application Pentesting, Threat Intelligence, and SIEM Operations**.  
Currently exploring **Incident Response, API Security, and Open Source Security Projects**.  
...
![JavaScript](https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black) ![SQL](https://img.shields.io/badge/SQL-003B57?style=for-the-badge&logo=postgresql&logoColor=white)  
...
Burp Suite | Nmap | Wireshark | OWASP ZAP | SQLMap | Nessus | OpenVAS | Splunk | ELK Stack  

**🌐 Domains & Knowledge:**  
Web App Security (OWASP Top 10) | Threat Intelligence | SIEM | Vulnerability Assessment | Network Security | Incident Detection & Response  
...
*Real-time packet analysis tool using Wireshark libraries to detect anomalies and threats.*  

🛡️ [**Vulnerability Scanner**](https://github.com/abhis59060/Vulnerability_scanner)  
*A lightweight web vulnerability scanner to detect OWASP Top 10 issues.*  
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=abhis59060&layout=compact&theme=radical)  
...
- EC-Council: SQL Injection Attack (2024)  
- Upgrade Campus: Data Structures & Algorithms  
- Naresh IT: C Programming  
...
---
⭐️ _“Cybersecurity is not just about defense — it’s about building trust.”_  
